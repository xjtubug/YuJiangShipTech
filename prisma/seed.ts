...
async function main() {
  ...
  const products = [
    // ── Marine Valves ──
    {
      ...
      moq: 10,
      leadTimeDays: 25,
      images: images('/uploads/product-1.jpg', '/uploads/product-1-2.jpg'),
      featured: true,
      published: true,
    ...
    },
    {
      ...
      moq: 5,
      leadTimeDays: 20,
      images: images('/uploads/product-2.jpg', '/uploads/product-2-2.jpg'),
      featured: false,
      published: true,
      categoryId: CAT.valves,
    },
    // ── Ship Pumps ──
    {
      ...
      moq: 2,
      leadTimeDays: 35,
      images: images('/uploads/product-3.jpg', '/uploads/product-3-2.jpg'),
      featured: true,
      published: true,
    ...
    },
    {
      ...
      moq: 3,
      leadTimeDays: 28,
      images: images('/uploads/product-4.jpg'),
      featured: false,
      published: true,
      categoryId: CAT.pumps,
    },
    // ── Deck Equipment ──
    {
      ...
      moq: 1,
      leadTimeDays: 60,
      images: images('/uploads/product-5.jpg', '/uploads/product-5-2.jpg'),
      featured: true,
      published: true,
      categoryId: CAT.deck,
    },
    {
      ...
      moq: 1,
      leadTimeDays: 55,
      images: images('/uploads/product-6.jpg', '/uploads/product-6-2.jpg'),
      featured: false,
      published: true,
      categoryId: CAT.deck,
    },
    // ── Navigation Equipment ──
    {
      ...
      moq: 1,
      leadTimeDays: 30,
      images: images('/uploads/product-7.jpg'),
      featured: true,
      published: true,
    ...
    },
    {
      ...
      moq: 2,
      leadTimeDays: 20,
      images: images('/uploads/product-8.jpg'),
      featured: false,
      published: true,
      categoryId: CAT.navigation,
    },
    // ── Safety Equipment ──
    {
      ...
      moq: 4,
      leadTimeDays: 15,
      images: images('/uploads/product-9.jpg', '/uploads/product-9-2.jpg'),
      featured: true,
      published: true,
    ...
    },
    {
      ...
      moq: 1,
      leadTimeDays: 40,
      images: images('/uploads/product-10.jpg'),
      featured: false,
      published: true,
      categoryId: CAT.safety,
    },
    // ── Engine Parts ──
    {
      ...
      moq: 2,
      leadTimeDays: 45,
      images: images('/uploads/product-11.jpg', '/uploads/product-11-2.jpg'),
      featured: false,
      published: true,
    ...
    },
    {
      ...
      moq: 1,
      leadTimeDays: 50,
      images: images('/uploads/product-12.jpg', '/uploads/product-12-2.jpg'),
      featured: true,
      published: true,
      categoryId: CAT.engine,
    },
