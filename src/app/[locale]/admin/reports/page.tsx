          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {countryPieData.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <ResponsiveContainer width="100%" height={260}>
                  <PieChart>
                    <Pie data={countryPieData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={90} label={({ name, percent }: PieLabelRenderProps) => `${name} ${(Number(percent ?? 0) * 100).toFixed(0)}%`}>
            ...
            {browserPie.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <ResponsiveContainer width="100%" height={260}>
                  <PieChart>
                    <Pie data={browserPie} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={90} label={({ name, percent }: PieLabelRenderProps) => `${name} ${(Number(percent ?? 0) * 100).toFixed(0)}%`}>
            ...
            {devicePie.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <ResponsiveContainer width="100%" height={260}>
                  <PieChart>
                    <Pie data={devicePie} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={90} label={({ name, percent }: PieLabelRenderProps) => `${name} ${(Number(percent ?? 0) * 100).toFixed(0)}%`}>
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <ResponsiveContainer width="100%" height={260}>
                <PieChart>
                  <Pie data={statusPie} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={90} label={({ name, percent }: PieLabelRenderProps) => `${name} ${(Number(percent ?? 0) * 100).toFixed(0)}%`}>
