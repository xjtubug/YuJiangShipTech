...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      titleEn, titleZh, titleJa, titleAr,
      contentEn, contentZh, contentJa, contentAr,
      excerpt, image, images, source, sourceUrl,
      published, category, autoGenerated,
    } = body;
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const body = await request.json();
    const {
      id, titleEn, titleZh, titleJa, titleAr,
      contentEn, contentZh, contentJa, contentAr,
      excerpt, image, images, source, sourceUrl,
      published, category,
    } = body;
